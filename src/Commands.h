...
#define COMMANDS(V)                                                       \
    ...
    V(CmdToggleContinuousViewVertically, "Toggle Continuous View Vertically")                  \
    V(CmdToggleContinuousViewHorizontally, "Toggle Continuous View Horizontally")              \
    V(CmdToggleReversePages, "Toggle Reverse Pages")                      \
